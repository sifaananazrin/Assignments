      ...
      <div className="max-w-md w-full bg-black p-4 md:p-8 rounded-lg shadow-2xl">
        <div className="flex flex-col items-center">
          ...
          <div className="text-center mt-4">
            ...
            <p className="text-sm sm:text-base text-white mt-2">Thank You For Submit Form</p>
            <button className="mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700 text-sm sm:text-base">
              OK
            </button>
          </div>
        </div>
